...
class User extends BaseUser
{
     ...
     * @return User
     */
    public function addConversation(\abs\fivepointsBundle\Entity\conversation $conversation)
    {
     ...
     * @return boolean TRUE if this collection contained the specified element, FALSE otherwise.
     */
    public function removeConversation(\abs\fivepointsBundle\Entity\conversation $conversation)
    {
